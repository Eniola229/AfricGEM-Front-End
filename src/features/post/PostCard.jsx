...
function PostCard({ post = {} }) {
  const { date, body, img, subimgs, author, tags } = post;
  return (
    <div className="h-full w-full  flex items-center justify-center">
      <div className="border max-w-screen-md bg-slate-50 mt-6 rounded-2xl p-4">
        <div className="flex items-center	justify-between">
          <div className="gap-3.5	flex items-center ">
            ...
            <div className="flex flex-col">
              <b className="mb-2 capitalize">{author}</b>
        ...
        <div className="whitespace-pre-wrap mt-7">Hello guys {body}</div>
        <div className="mt-5 flex gap-2	 justify-center border-b pb-4 flex-wrap	">
          <img
            ...
            src={img}
            className="bg-yellow-500 rounded-2xl w-1/3 object-cover h-52 flex-auto"
            alt="phot"
          />
          <img
